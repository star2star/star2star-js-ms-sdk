...
**/
const getTaskTemplates = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt' ) => {
...
**/
const createTaskTemplate = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt', title="missing-stuff", defaultTasks=[] ) => {
...
* @returns promise
**/
const deleteTaskTemplate  = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt',
                              task_template_uuid="missing task uuid" ) => {
    return Objects.deleteDataObject(apiKey, userUUID, identityJWT, task_template_uuid );
}
/**
...
* @returns promise for creating object
**/
const createTaskObject  = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt',
...
* @returns promise
**/
const deleteTaskObject  = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt',
                              task_uuid="missing task uuid" ) => {
    return Objects.deleteDataObject(apiKey, userUUID, identityJWT, task_uuid );
}
...
* @returns promise
**/
const getTaskObject  = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt',
...
* @returns promise
**/
const updateTaskObject  = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt',
                              uuid="missing_uuid",  taskObject={} ) => {
...
* @returns promise
**/
const addTaskToTaskObject  = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt',
                              taskObjectUUID="missing_uuid",  task={} ) => {
...
* @returns promise
**/
const updateTaskInTaskObject  = (apiKey='null api key', userUUID='null user uuid', identityJWT='null jwt',
                              taskObjectUUID="missing_uuid",  task={} ) => {
    const vTasks = validateTasks([task]);
    //console.log('----', vTasks)
    if (vTasks.status === 200){
...
module.exports = { getTaskTemplates, createTaskTemplate, deleteTaskTemplate,
  createTaskObject, deleteTaskObject, getTaskObject, updateTaskObject, addTaskToTaskObject, updateTaskInTaskObject}
