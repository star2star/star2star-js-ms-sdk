...
var Logger = /*#__PURE__*/function () {
  function Logger() {
    ...
    var prettyPrint = typeof Util.getThis().MS_LOGPRETTY === "undefined" ? Util.getThis().MS_LOGPRETTY : false;
    ...
    this.logger = createLogger({
      ...
      transports: [new transports.Console({
        level: typeof Util.getThis().MS_LOGLEVEL === "undefined" ? Util.getThis().MS_LOGLEVEL : "info"
      })]
    });
    return this;
