    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            oauthToken = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : "null oauth token";
            email = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : "null email";
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            clientUUID = _args7.length > 1 && _args7[1] !== undefined ? _args7[1] : "null clientUUID";
            scope = _args7.length > 2 && _args7[2] !== undefined ? _args7[2] : ["default"];
