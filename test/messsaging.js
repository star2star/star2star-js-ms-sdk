...
describe('Messaging MS', function() {
  it('Valid SMS Number', function(done) {
    ...
    s2sMS.getSMSNumber(creds.CPAAS_KEY,  "0904f8d5-627f-4ff5-b34d-68dc96487b1e").then((sms)=>{
  ...
  it('Send SMS', function(done) {
      if (!creds.isValid) return done();
      s2sMS.sendSMS(creds.CPAAS_KEY, "0904f8d5-627f-4ff5-b34d-68dc96487b1e", "msg", "+19414441241", "+19418076677" ).then((x)=>{
