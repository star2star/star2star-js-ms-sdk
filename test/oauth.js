...
describe("Oauth MS Unit Test Suite", function () {
  ...
  it(
    ...
    mochaAsync(async () => {
      trace = Util.generateNewMetaData(trace);
      const response = await s2sMS.Oauth.getClientToken(
        process.env.BASIC_TOKEN,
        trace
      );
      assert.ok(
  ...
  it(
    ...
    mochaAsync(async () => {
      trace = Util.generateNewMetaData(trace);
      const response = await s2sMS.Oauth.listScopes(
        accessToken,
  ...
  it(
    ...
    mochaAsync(async () => {
      trace = Util.generateNewMetaData(trace);
      const response = await s2sMS.Oauth.validateToken(
        accessToken,
        clientAccessToken,
        trace
      );
  ...
  it(
    ...
    mochaAsync(async () => {
      trace = Util.generateNewMetaData(trace);
      const response = await s2sMS.Oauth.invalidateToken(
        accessToken,
        clientAccessToken,
        trace
      );
